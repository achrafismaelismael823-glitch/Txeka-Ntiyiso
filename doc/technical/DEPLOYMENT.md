...
#
# Alinhamento: Lei 3/2017, Decreto 32/2021, Resolução 69/2021
...
LABEL country="MZ"
LABEL timezone="CAT"
LABEL legislation="Lei 3/2017, Decreto 32/2021"
...
- **Locale `pt_MZ.UTF-8` e TZ `Africa/Maputo`**: Garante timestamps auditáveis em CAT (UTC+2), conforme Decreto n.º 32/2021.
...
| **Decreto 32/2021** — Conservação de hashes e logs | Volume `txeka-data` persistente (não AC) | `docker-compose.yml` |
| **Decreto 32/2021** — Auditoria cronológica | TZ Africa/Maputo, locale pt_MZ | `Dockerfile` |
