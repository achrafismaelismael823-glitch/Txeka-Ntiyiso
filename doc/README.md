...
| ⚖️ **Jurista / Auditor / Regulador** | [Dossiê de Conformidade](legal/COMPLIANCE.md) · [Declaração de Posicionamento](../POSITIONING.md) | Lei 3/2017, Decreto 59/2019 (SCDM), posicionamento não-ICP, responsabilidades |
...
└── legal/
    ...
    └── COMPLIANCE.md      ← Conformidade Lei 3/2017, Decreto 59/2019 (SCDM)
```
