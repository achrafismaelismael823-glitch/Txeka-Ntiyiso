...
Migration unica, idempotente e enterprise-grade.
PK String(100) em institutions, consistente com models.py.
...
def upgrade() -> None:
    """Cria schema completo com PK String, constraints e indices otimizados."""
...
def downgrade() -> None:
    """Remove schema na ordem correta."""
